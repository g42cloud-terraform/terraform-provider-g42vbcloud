...
```hcl
resource "g42vbcloud_obs_bucket" "b" {
...
* `bucket_domain_name` - The bucket domain name. Will be of format `bucketname.obs.region.g42vbcloud.com`.
...
```
$ terraform import g42vbcloud_obs_bucket.bucket <bucket-name>
```

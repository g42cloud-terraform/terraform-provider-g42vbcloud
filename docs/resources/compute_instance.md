...
# g42vbcloud_compute_instance

Manages a ECS VM instance resource within G42VBCloud.
...
data "g42vbcloud_compute_flavors" "myflavor" {
...
data "g42vbcloud_images_image" "myimage" {
  name        = "Ubuntu 18.04 server 64bit"
  most_recent = true
}

resource "g42vbcloud_compute_instance" "basic" {
  name              = "basic"
  image_id          = data.g42vbcloud_images_image.myimage.id
  flavor_id         = data.g42vbcloud_compute_flavors.myflavor.ids[0]
  security_groups   = ["default"]
  availability_zone = data.g42vbcloud_availability_zones.myaz.names[0]

  network {
    uuid = data.g42vbcloud_vpc_subnet.mynet.id
  }
}
```
...
```hcl
resource "g42vbcloud_compute_instance" "multi-disk" {
  name              = "multi-net"
  image_id          = "ad091b52-742f-469e-8f3c-fd81cadf0743"
  flavor_id         = "s6.small.1"
  key_pair          = "my_key_pair_name"
...
```hcl
resource "g42vbcloud_compute_instance" "multi-net" {
  name              = "multi-net"
  image_id          = "ad091b52-742f-469e-8f3c-fd81cadf0743"
  flavor_id         = "s6.small.1"
  key_pair          = "my_key_pair_name"
...
* `availability_zone` - (Required, String, ForceNew) The availability zone in which to create
    the server. Please following [reference](https://docs.vb.g42cloud.com/en-us/endpoint/index.html)
...
* `system_disk_type` - (Optional, String, ForceNew) Specifies the system disk type of the instance.
  ...
  [Disk Types and Disk Performance](https://docs.vb.g42cloud.com/en-us/usermanual/evs/en-us_topic_0014580744.html)
...
```
terraform import g42vbcloud_compute_instance.my_instance b11b407c-e604-4e8d-8bc4-92398320b847
```

...
# g42vbcloud_ces_alarmrule

Manages a Cloud Eye alarm rule resource within G42VBCloud.
...
* `namespace` - (Required, String) Specifies the namespace in **service.item** format.
    ...
    For details, see [Services Interconnected with Cloud Eye](https://docs.vb.g42cloud.com/api/ces/en-us_topic_0171212593.html).
...
```
$ terraform import g42vbcloud_ces_alarmrule.alarm_rule al1619578509719Ga0X1RGWv
```

...
# g42vbcloud_evs_volume

Manages a volume resource within G42VBCloud.

## Example Usage

```hcl
resource "g42vbcloud_evs_volume" "volume" {
  name              = "volume"
...
```
$ terraform import g42vbcloud_evs_volume.volume_1 14a80bc7-c12c-4fe0-a38a-cb77eeac9bd6
```
...
```
resource "g42vbcloud_evs_volume" "volume_1" {
    ...

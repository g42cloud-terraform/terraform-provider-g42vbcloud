...
# g42vbcloud\_dns\_zone

Manages a DNS zone in the G42VBCloud DNS Service.
...
```hcl
resource "g42vbcloud_dns_zone" "my_public_zone" {
  name        = "example.com."
...
```hcl
resource "g42vbcloud_dns_zone" "my_private_zone" {
  name        = "1.example.com."
  email       = "jdoe@example.com"
  description = "An example zone"
  ttl         = 3000
...
```
$ terraform import g42vbcloud_dns_zone.zone_1 <zone_id>
```

...
# g42vbcloud\_fgs\_function

Manages a Function resource within G42VBCloud.
...
```hcl
resource "g42vbcloud_fgs_function" "f_1" {
  name        = "func_1"
  app         = "default"
  agency      = "test"
...
```
$ terraform import g42vbcloud_fgs_function.my-func 7117d38e-4c8f-4624-a505-bd96b97d024c
```

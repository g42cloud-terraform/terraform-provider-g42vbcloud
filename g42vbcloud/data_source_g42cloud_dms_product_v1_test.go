		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDmsProductV1DataSourceID("data.g42vbcloud_dms_product.product1"),
					resource.TestCheckResourceAttr(
						"data.g42vbcloud_dms_product.product1", "engine", "kafka"),
					resource.TestCheckResourceAttr(
						"data.g42vbcloud_dms_product.product1", "bandwidth", "100MB"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDmsProductV1DataSourceID("data.g42vbcloud_dms_product.product1"),
					resource.TestCheckResourceAttr(
						"data.g42vbcloud_dms_product.product1", "engine", "rabbitmq"),
					resource.TestCheckResourceAttr(
						"data.g42vbcloud_dms_product.product1", "node_num", "3"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"data.g42vbcloud_dms_product.product1", "engine", "rabbitmq"),
					resource.TestCheckResourceAttr(
						"data.g42vbcloud_dms_product.product1", "node_num", "5"),
				),
			},
		},
	})

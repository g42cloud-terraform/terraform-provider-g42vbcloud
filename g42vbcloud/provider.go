...
func Provider() *schema.Provider {
	provider := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"g42vbcloud_dds_flavors":         huaweicloud.DataSourceDDSFlavorV3(),
			...
			"g42vbcloud_dms_az":              huaweicloud.DataSourceDmsAZV1(),
			"g42vbcloud_dms_product":         huaweicloud.DataSourceDmsProductV1(),
			"g42vbcloud_dms_maintainwindow":  huaweicloud.DataSourceDmsMaintainWindowV1(),
			...
			"g42vbcloud_rds_flavors":         huaweicloud.DataSourceRdsFlavorV3(),
			"g42vbcloud_vpc":                 vpc.DataSourceVpcV1(),
			"g42vbcloud_vpc_bandwidth":       vpc.DataSourceBandWidth(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"g42vbcloud_dds_instance":              huaweicloud.ResourceDdsInstanceV3(),
			...
			"g42vbcloud_evs_volume":                huaweicloud.ResourceEvsStorageVolumeV3(),
			...
			"g42vbcloud_vpc_bandwidth":             vpc.ResourceVpcBandWidthV2(),
			"g42vbcloud_vpc_eip":                   vpc.ResourceVpcEIPV1(),

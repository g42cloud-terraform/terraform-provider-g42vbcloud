		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"g42vbcloud_obs_bucket_object.object", "key", "test-key"),
					resource.TestCheckResourceAttr(
						"g42vbcloud_obs_bucket_object.object", "content_type", "binary/octet-stream"),
					resource.TestCheckResourceAttr(
						"g42vbcloud_obs_bucket_object.object", "storage_class", "STANDARD"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"g42vbcloud_obs_bucket_object.object", "encryption", "true"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"g42vbcloud_obs_bucket_object.object", "key", "test-key"),
					resource.TestCheckResourceAttr(
						"g42vbcloud_obs_bucket_object.object", "size", "19"),
				),
			},
		},
	})
...
func testAccCheckObsBucketObjectDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "g42vbcloud_obs_bucket_object" {
			continue
		}

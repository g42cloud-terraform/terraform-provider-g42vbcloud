...
func TestAccNetworkingV2EIPAssociate_basic(t *testing.T) {
	...
	resourceName := "g42vbcloud_networking_eip_associate.test"
...
resource "g42vbcloud_networking_eip_associate" "test" {
  public_ip = g42vbcloud_vpc_eip.test.address
  port_id   = g42vbcloud_compute_instance.test.network[0].port
}

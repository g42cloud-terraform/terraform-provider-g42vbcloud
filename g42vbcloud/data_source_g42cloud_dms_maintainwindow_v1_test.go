		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDmsMaintainWindowV1DataSourceID("data.g42vbcloud_dms_maintainwindow.maintainwindow1"),
					resource.TestCheckResourceAttr(
						"data.g42vbcloud_dms_maintainwindow.maintainwindow1", "seq", "1"),
					resource.TestCheckResourceAttr(
						"data.g42vbcloud_dms_maintainwindow.maintainwindow1", "begin", "22"),
				),
			},
		},
	})
...
data "g42vbcloud_dms_maintainwindow" "maintainwindow1" {
  seq = 1
}
`)
